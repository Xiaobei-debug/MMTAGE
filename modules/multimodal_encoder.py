...
from modules.multimodal_layers.attention import MultiHeadAttention, SelfAttention
from modules.multimodal_layers.mlp import MLP
from modules.multimodal_layers.normalizations import Fp32LayerNorm

from modules.multimodal_layers.transformer import TransformerOutput
...
class FLAVATransformerWithoutEmbeddings(nn.Module):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        dropout=0.2,
        norm_first=True)
        self.layernorm = Fp32LayerNorm(hidden_size, eps=1e-12)
